...
const STEPS: { no: string; title: string; desc: string }[] = [
  {
    ...
    desc: "Join as a student or faculty member in seconds.",
  },
  {
    no: "2",
    title: "Know your interests",
    desc: "Answer a short questionnaire to get a role & roadmap that fit you.",
  },
  {
    no: "3",
    title: "Learn & connect",
    desc: "Follow the roadmap, join communities, and find a project team.",
  },
];
      ...
      <header className="sticky top-0 z-30 flex items-center gap-3 border-b border-line bg-canvas/80 px-6 py-4 backdrop-blur sm:px-8">
        ...
        <div className="ml-auto flex items-center gap-4">
          <button
            type="button"
            onClick={onLogin}
            className="cursor-pointer text-sm font-semibold text-muted hover:text-ink"
          >
            Log in
          </button>
          <button
        ...
        <div className="mx-auto flex max-w-5xl flex-col gap-10">
          <div className="flex flex-col gap-2">
            ...
            <p className="max-w-xl text-sm text-muted">
              From structured learning to real collaboration with people on your wavelength.
            </p>
          </div>
