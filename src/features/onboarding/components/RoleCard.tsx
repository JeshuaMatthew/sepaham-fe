...
import { CompassIcon, StarIcon } from "@/shared/icons";
    ...
    >
      ...
      <div className="mt-auto flex flex-wrap gap-1.5 pt-1">
        {role.techStack.map((tech) => (
          <span key={tech} className="rounded-md border border-line bg-canvas px-2 py-0.5 font-mono text-[11px] text-muted">
            {tech}
          </span>
        ))}
      </div>
